...
back-end. Limited work was done on the front-end with the exception of light
folder creation and HTML form creation.
...
### Tuesday
We had an incredibly successful day. We were able to completely setup the back
end API and we worked wonderfully together as a team. A section for
documentation on how to utilize the API may be found below. The only (real)
challenge that we ran into was working with the subdocuments and finding a way
to update those with the user's selection from each survey.
